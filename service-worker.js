...
const CACHE_VERSION="20260817-earthy3";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260817-earthy3","./app.js?v=20260817-earthy3","./polish.js?v=20260817-earthy3","./campus-data.js?v=20260817-earthy3","./manifest.webmanifest"];

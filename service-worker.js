...
const CACHE_VERSION="20260824-flow5";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260824-flow5","./visual.css?v=20260824-flow5","./app.js?v=20260824-flow5","./polish.js?v=20260824-flow5","./campus-data.js?v=20260824-flow5","./exam-data.js?v=20260824-flow5","./brand-mark.svg","./manifest.webmanifest"];

...
const CACHE_VERSION="20260827-homerev1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260827-homerev1","./app.js?v=20260827-homerev1","./polish.js?v=20260827-homerev1","./campus-data.js?v=20260827-homerev1","./exam-data.js?v=20260827-homerev1","./manifest.webmanifest"];

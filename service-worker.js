...
const CACHE_VERSION="20260819-phase15b";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260819-phase15b","./visual.css?v=20260819-phase15b","./app.js?v=20260819-phase15b","./polish.js?v=20260819-phase15b","./campus-data.js?v=20260819-phase15b","./manifest.webmanifest"];

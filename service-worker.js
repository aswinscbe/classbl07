...
const CACHE_VERSION="20260819-exams1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260819-exams1","./visual.css?v=20260819-exams1","./app.js?v=20260819-exams1","./polish.js?v=20260819-exams1","./campus-data.js?v=20260819-exams1","./exam-data.js?v=20260819-exams1","./manifest.webmanifest"];

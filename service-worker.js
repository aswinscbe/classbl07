...
const CACHE_VERSION="20260824-flow1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260824-flow1","./visual.css?v=20260824-flow1","./app.js?v=20260824-flow1","./polish.js?v=20260824-flow1","./campus-data.js?v=20260824-flow1","./exam-data.js?v=20260824-flow1","./brand-mark.svg","./manifest.webmanifest"];

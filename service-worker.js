...
const CACHE_VERSION="20260819-32";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260819-focus32","./visual.css?v=20260819-focus32","./app.js?v=20260819-focus32","./polish.js?v=20260819-focus32","./campus-data.js?v=20260819-focus32","./manifest.webmanifest"];

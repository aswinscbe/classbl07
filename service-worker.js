...
const CACHE_VERSION="20260824-stable6";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260824-stable6","./visual-base.css?v=20260824-stable6","./visual.css?v=20260824-stable6","./planner-final.css?v=20260824-stable6","./app.js?v=20260824-stable6","./polish.js?v=20260824-stable6","./campus-data.js?v=20260824-stable6","./exam-data.js?v=20260824-stable6","./brand-mark.svg?v=20260824-stable6","./manifest.webmanifest"];

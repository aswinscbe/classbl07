...
const CACHE_VERSION="20260902-nova81";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260902-nova81","./app.js?v=20260902-nova81","./polish.js?v=20260902-nova81","./campus-data.js?v=20260902-nova81","./exam-data.js?v=20260902-nova81","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-192.png","./icons/icon-maskable-512.png","./icons/apple-touch-icon.png","./icons/favicon-32.png","./icons/favicon-16.png"];

...
const CACHE_VERSION="20260827-nova5";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260827-nova5","./app.js?v=20260827-nova5","./polish.js?v=20260827-nova5","./campus-data.js?v=20260827-nova5","./exam-data.js?v=20260827-nova5","./manifest.webmanifest"];

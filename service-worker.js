...
const CACHE_VERSION="20260823-clean5";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260823-clean5","./visual.css?v=20260823-clean5","./app.js?v=20260823-clean5","./polish.js?v=20260823-clean5","./campus-data.js?v=20260823-clean5","./exam-data.js?v=20260823-clean5","./manifest.webmanifest"];

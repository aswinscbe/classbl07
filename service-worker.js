...
const CACHE_VERSION="20260817-flap1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260817-flap1","./app.js?v=20260817-flap1","./polish.js?v=20260817-flap1","./campus-data.js?v=20260817-flap1","./manifest.webmanifest"];

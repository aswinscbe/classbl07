...
const CACHE_VERSION="20260826-calendarpass2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260826-calendarpass2","./app.js?v=20260826-calendarpass2","./polish.js?v=20260826-calendarpass2","./campus-data.js?v=20260826-calendarpass2","./exam-data.js?v=20260826-calendarpass2","./manifest.webmanifest"];

...
const CACHE_VERSION="20260825-system7";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260825-system7","./visual-base.css?v=20260825-system7","./visual.css?v=20260825-system7","./planner-final.css?v=20260825-system7","./premium-system.css?v=20260825-system7","./app.js?v=20260825-system7","./polish.js?v=20260825-system7","./campus-data.js?v=20260825-system7","./exam-data.js?v=20260825-system7","./brand-mark.svg?v=20260825-system7","./manifest.webmanifest"];

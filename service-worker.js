...
const CACHE_VERSION="20260827-schedule3";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260827-schedule3","./app.js?v=20260827-schedule3","./polish.js?v=20260827-schedule3","./campus-data.js?v=20260827-schedule3","./exam-data.js?v=20260827-schedule3","./manifest.webmanifest"];

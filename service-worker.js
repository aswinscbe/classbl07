...
const CACHE_VERSION="20260823-editorial2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260823-editorial2","./visual.css?v=20260823-editorial2","./app.js?v=20260823-editorial2","./polish.js?v=20260823-editorial2","./campus-data.js?v=20260823-editorial2","./exam-data.js?v=20260823-editorial2","./manifest.webmanifest"];

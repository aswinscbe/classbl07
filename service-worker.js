...
const CACHE_VERSION="20260826-calendarpass1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260826-calendarpass1","./app.js?v=20260826-calendarpass1","./polish.js?v=20260826-calendarpass1","./campus-data.js?v=20260826-calendarpass1","./exam-data.js?v=20260826-calendarpass1","./manifest.webmanifest"];

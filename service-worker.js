...
const CACHE_VERSION="20260825-system6";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260825-system6","./visual-base.css?v=20260825-system6","./visual.css?v=20260825-system6","./planner-final.css?v=20260825-system6","./premium-system.css?v=20260825-system6","./app.js?v=20260825-system6","./polish.js?v=20260825-system6","./campus-data.js?v=20260825-system6","./exam-data.js?v=20260825-system6","./brand-mark.svg?v=20260825-system6","./manifest.webmanifest"];

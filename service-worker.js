...
const CACHE_VERSION="20260825-hero2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260825-hero2","./visual-base.css?v=20260825-hero2","./visual.css?v=20260825-hero2","./planner-final.css?v=20260825-hero2","./app.js?v=20260825-hero2","./polish.js?v=20260825-hero2","./campus-data.js?v=20260825-hero2","./exam-data.js?v=20260825-hero2","./brand-mark.svg?v=20260825-hero2","./manifest.webmanifest"];

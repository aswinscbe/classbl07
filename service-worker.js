...
const CACHE_VERSION="20260819-phase1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260819-phase1","./visual.css?v=20260819-phase1","./app.js?v=20260819-phase1","./polish.js?v=20260819-phase1","./campus-data.js?v=20260819-phase1","./manifest.webmanifest"];

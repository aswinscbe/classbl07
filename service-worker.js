...
const CACHE_VERSION="20260823-editorial4";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260823-editorial4","./visual.css?v=20260823-editorial4","./app.js?v=20260823-editorial4","./polish.js?v=20260823-editorial4","./campus-data.js?v=20260823-editorial4","./exam-data.js?v=20260823-editorial4","./manifest.webmanifest"];

...
const CACHE_VERSION="20260824-flow3";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260824-flow3","./visual.css?v=20260824-flow3","./app.js?v=20260824-flow3","./polish.js?v=20260824-flow3","./campus-data.js?v=20260824-flow3","./exam-data.js?v=20260824-flow3","./brand-mark.svg","./manifest.webmanifest"];

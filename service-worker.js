...
const CACHE_VERSION="20260818-sleek1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260818-sleek1","./app.js?v=20260818-sleek1","./polish.js?v=20260818-sleek1","./campus-data.js?v=20260818-sleek1","./exam-data.js?v=20260818-sleek1","./manifest.webmanifest"];

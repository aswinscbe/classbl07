...
const CACHE_VERSION="20260827-nova4";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260827-nova4","./app.js?v=20260827-nova4","./polish.js?v=20260827-nova4","./campus-data.js?v=20260827-nova4","./exam-data.js?v=20260827-nova4","./manifest.webmanifest"];

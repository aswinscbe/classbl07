...
const CACHE_VERSION="20260823-clean4";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260823-clean4","./visual.css?v=20260823-clean4","./app.js?v=20260823-clean4","./polish.js?v=20260823-clean4","./campus-data.js?v=20260823-clean4","./exam-data.js?v=20260823-clean4","./manifest.webmanifest"];

...
const CACHE_VERSION="20260827-nova3";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260827-nova3","./app.js?v=20260827-nova3","./polish.js?v=20260827-nova3","./campus-data.js?v=20260827-nova3","./exam-data.js?v=20260827-nova3","./manifest.webmanifest"];

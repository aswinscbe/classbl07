...
const CACHE_VERSION="20260825-premium7";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260825-premium7","./app.js?v=20260825-premium7","./polish.js?v=20260825-premium7","./campus-data.js?v=20260825-premium7","./exam-data.js?v=20260825-premium7","./brand-mark.svg?v=20260825-premium7","./manifest.webmanifest"];

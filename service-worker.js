...
const CACHE_VERSION="20260824-flow4";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260824-flow4","./visual.css?v=20260824-flow4","./app.js?v=20260824-flow4","./polish.js?v=20260824-flow4","./campus-data.js?v=20260824-flow4","./exam-data.js?v=20260824-flow4","./brand-mark.svg","./manifest.webmanifest"];

...
const CACHE_VERSION="20260819-phase15c";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260819-phase15c","./visual.css?v=20260819-phase15c","./app.js?v=20260819-phase15c","./polish.js?v=20260819-phase15c","./campus-data.js?v=20260819-phase15c","./manifest.webmanifest"];

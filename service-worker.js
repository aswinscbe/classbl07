...
const CACHE_VERSION="20260827-premiumpass1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260827-premiumpass1","./app.js?v=20260827-premiumpass1","./polish.js?v=20260827-premiumpass1","./campus-data.js?v=20260827-premiumpass1","./exam-data.js?v=20260827-premiumpass1","./manifest.webmanifest"];

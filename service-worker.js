...
const CACHE_VERSION="20260818-sleek2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260818-sleek2","./app.js?v=20260818-sleek2","./polish.js?v=20260818-sleek2","./campus-data.js?v=20260818-sleek2","./exam-data.js?v=20260818-sleek2","./manifest.webmanifest"];

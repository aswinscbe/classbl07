...
const CACHE_VERSION="20260825-plumcopper2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260825-plumcopper2","./app.js?v=20260825-plumcopper2","./polish.js?v=20260825-plumcopper2","./campus-data.js?v=20260825-plumcopper2","./exam-data.js?v=20260825-plumcopper2","./manifest.webmanifest"];

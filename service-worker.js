...
const CACHE_VERSION="20260827-schedule2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260827-schedule2","./app.js?v=20260827-schedule2","./polish.js?v=20260827-schedule2","./campus-data.js?v=20260827-schedule2","./exam-data.js?v=20260827-schedule2","./manifest.webmanifest"];

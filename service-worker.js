...
const CACHE_VERSION="20260823-editorial1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260823-editorial1","./visual.css?v=20260823-editorial1","./app.js?v=20260823-editorial1","./polish.js?v=20260823-editorial1","./campus-data.js?v=20260823-editorial1","./exam-data.js?v=20260823-editorial1","./manifest.webmanifest"];

...
const CACHE_VERSION="20260819-phase15";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260819-phase15","./visual.css?v=20260819-phase15","./app.js?v=20260819-phase15","./polish.js?v=20260819-phase15","./campus-data.js?v=20260819-phase15","./manifest.webmanifest"];

...
const CACHE_VERSION="20260824-flow2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260824-flow2","./visual.css?v=20260824-flow2","./app.js?v=20260824-flow2","./polish.js?v=20260824-flow2","./campus-data.js?v=20260824-flow2","./exam-data.js?v=20260824-flow2","./brand-mark.svg","./manifest.webmanifest"];

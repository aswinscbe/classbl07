...
const CACHE_VERSION="20260825-premium6";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260825-premium6","./app.js?v=20260825-premium6","./polish.js?v=20260825-premium6","./campus-data.js?v=20260825-premium6","./exam-data.js?v=20260825-premium6","./brand-mark.svg?v=20260825-premium6","./manifest.webmanifest"];

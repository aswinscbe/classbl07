...
const CACHE_VERSION="20260817-earthy4";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260817-earthy4","./app.js?v=20260817-earthy4","./polish.js?v=20260817-earthy4","./campus-data.js?v=20260817-earthy4","./manifest.webmanifest"];

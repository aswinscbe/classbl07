...
const CACHE_VERSION="20260825-plumcopper";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260825-plumcopper","./app.js?v=20260825-plumcopper","./polish.js?v=20260825-plumcopper","./campus-data.js?v=20260825-plumcopper","./exam-data.js?v=20260825-plumcopper","./manifest.webmanifest"];

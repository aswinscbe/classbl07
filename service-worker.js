...
const CACHE_VERSION="20260823-clean1";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260823-clean1","./visual.css?v=20260823-clean1","./app.js?v=20260823-clean1","./polish.js?v=20260823-clean1","./campus-data.js?v=20260823-clean1","./exam-data.js?v=20260823-clean1","./manifest.webmanifest"];

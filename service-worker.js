...
const CACHE_VERSION="20260824-stable7";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260824-stable7","./visual-base.css?v=20260824-stable7","./visual.css?v=20260824-stable7","./planner-final.css?v=20260824-stable7","./app.js?v=20260824-stable7","./polish.js?v=20260824-stable7","./campus-data.js?v=20260824-stable7","./exam-data.js?v=20260824-stable7","./brand-mark.svg?v=20260824-stable7","./manifest.webmanifest"];

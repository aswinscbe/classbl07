...
const CACHE_VERSION="20260817-earthy2";
const ACTIVE_CACHE=`${CACHE}-${CACHE_VERSION}`;
const SHELL=["./index.html","./styles.css?v=20260817-earthy2","./app.js?v=20260817-earthy2","./polish.js?v=20260817-earthy2","./campus-data.js?v=20260817-earthy2","./manifest.webmanifest"];
